...
(function () {
  ...
  function renderCallGame(game) {
    ...
    if (!game) { content.innerHTML = `<div class="game-picker"><button class="game-choice" data-game-type="blackjack"><strong>Blackjack</strong><span>Shared dealer table.</span></button><button class="game-choice" data-game-type="poker"><strong>Texas Hold'em</strong><span>Private cards and a shared pot.</span></button></div>`; return; }

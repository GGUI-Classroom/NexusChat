...
const DECORATIONS = [
  ...
  { id: 'shatter',      nexalPrice: null, name: 'Shatter',         description: 'Glass forms over your avatar then dramatically shatters. Reforms every 5s.', rarity: 'mythical', preview: 'shatter' },
];
